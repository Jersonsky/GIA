...
if(isset($_POST['insert'])){
	$newCalifica = new Califica("", $periodo_1, $periodo_2, $periodo_3, $periodo_4, $clase, $estudiante);
	$newCalifica -> insert();
	...
	if($_SESSION['entity'] == 'Administrador'){
		$logAdministrador = new LogAdministrador("","Crear Califica", "Periodo_1: " . $periodo_1 . "; Periodo_2: " . $periodo_2 . "; Periodo_3: " . $periodo_3 . "; Periodo_4: " . $periodo_4 . "; Clase: " . $nameClase . ";; Estudiante: " . $nameEstudiante , date("Y-m-d"), date("H:i:s"), $user_ip, PHP_OS, $browser, $_SESSION['id']);
		...
		<div class="col-md-8">
			<div class="card">
				<div class="card-header">
					<h4 class="card-title">Crear Califica</h4>
				</div>
				<div class="card-body">
					<?php if($processed){ ?>
					...
					<?php } ?>
					<form id="form" method="post" action="index.php?pid=<?php echo base64_encode("ui/califica/insertCalifica.php") ?>" class="bootstrap-form needs-validation"   >
						<div class="form-group">
							<label>Periodo_1*</label>
							<input type="text" class="form-control" name="periodo_1" value="<?php echo $periodo_1 ?>" required />
						</div>
						<div class="form-group">
							<label>Periodo_2*</label>
							<input type="text" class="form-control" name="periodo_2" value="<?php echo $periodo_2 ?>" required />
						</div>
						<div class="form-group">
							<label>Periodo_3*</label>
							<input type="text" class="form-control" name="periodo_3" value="<?php echo $periodo_3 ?>" required />
						</div>
						<div class="form-group">
							<label>Periodo_4*</label>
							<input type="text" class="form-control" name="periodo_4" value="<?php echo $periodo_4 ?>" required />
						</div>
					<div class="form-group">
						<label>Clase*</label>
