...
<div class="container-fluid">
	<div class="card">
		<div class="card-header">
			<h4 class="card-title">Consultar Clase de Materia: <em><?php echo $materia -> getNombremateria() ?></em></h4>
		</div>
		<div class="card-body">
			...
			<table class="table table-striped table-hover">
				<thead>
					<tr><th></th>
						...
						<?php } else { ?>
							<a data-toggle='tooltip' class='tooltipLink' data-original-title='Ordenar Ascendente' href='index.php?pid=<?php echo base64_encode("ui/clase/selectAllClaseByMateria.php") ?>&idMateria=<?php echo $_GET['idMateria'] ?>&order=descripcion&dir=asc'>
							<span class='fas fa-sort-amount-up'></span></a>
						<?php } ?>
						<?php if($order=="descripcion" && $dir=="desc") { ?>
							<span class='fas fa-sort-down'></span>
						<?php } else { ?>
							<a data-toggle='tooltip' class='tooltipLink' data-original-title='Ordenar Descendente' href='index.php?pid=<?php echo base64_encode("ui/clase/selectAllClaseByMateria.php") ?>&idMateria=<?php echo $_GET['idMateria'] ?>&order=descripcion&dir=desc'>
					...
					<?php
					$clase = new Clase("", "", $_GET['idMateria'], "", "");
					if($order!="" && $dir!="") {
						$clases = $clase -> selectAllByMateriaOrder($order, $dir);
					} else {
						$clases = $clase -> selectAllByMateria();
					}
					$counter = 1;
