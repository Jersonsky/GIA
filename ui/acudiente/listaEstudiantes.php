        				...
        				<thead>
        					...
        					foreach ($acudientes as $currentAcudientes) {
        						...
        						echo "<td class='text-right' nowrap>
                        				<a href='modalNotasAcudiente.php?idEstudiante=" . $currentAcudientes -> getIdAcudiente() . "'  data-toggle='modal' data-target='#modalNotasA' >
...
<div class="modal fade" id="modalNotasA" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
