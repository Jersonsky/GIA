...
$matriculaEstudiante = new MatriculaEstudiante($_GET['idMatriculaEstudiante']); 
$matriculaEstudiante -> select();
?>
<div class="container-fluid">
	<div class="card">
		<div class="card-header">
			<h4 class="card-title">Consultar Observador de Matricula Estudiante: <em><?php echo $matriculaEstudiante -> getDescripcion() ?></em></h4>
		</div>
		<div class="card-body">
			...
			<table class="table table-striped table-hover">
				<thead>
					<tr><th></th>
						...
						<?php } else { ?>
							<a data-toggle='tooltip' class='tooltipLink' data-original-title='Ordenar Ascendente' href='index.php?pid=<?php echo base64_encode("ui/observador/selectAllObservadorByMatriculaEstudiante.php") ?>&idMatriculaEstudiante=<?php echo $_GET['idMatriculaEstudiante'] ?>&order=descripcion&dir=asc'>
							<span class='fas fa-sort-amount-up'></span></a>
						<?php } ?>
						<?php if($order=="descripcion" && $dir=="desc") { ?>
							<span class='fas fa-sort-down'></span>
						<?php } else { ?>
							<a data-toggle='tooltip' class='tooltipLink' data-original-title='Ordenar Descendente' href='index.php?pid=<?php echo base64_encode("ui/observador/selectAllObservadorByMatriculaEstudiante.php") ?>&idMatriculaEstudiante=<?php echo $_GET['idMatriculaEstudiante'] ?>&order=descripcion&dir=desc'>
						...
						<?php if($order=="fecha" && $dir=="asc") { ?>
							<span class='fas fa-sort-up'></span>
						<?php } else { ?>
							<a data-toggle='tooltip' class='tooltipLink' data-original-title='Ordenar Ascendente' href='index.php?pid=<?php echo base64_encode("ui/observador/selectAllObservadorByMatriculaEstudiante.php") ?>&idMatriculaEstudiante=<?php echo $_GET['idMatriculaEstudiante'] ?>&order=fecha&dir=asc'>
							<span class='fas fa-sort-amount-up'></span></a>
						<?php } ?>
						<?php if($order=="fecha" && $dir=="desc") { ?>
							<span class='fas fa-sort-down'></span>
						<?php } else { ?>
							<a data-toggle='tooltip' class='tooltipLink' data-original-title='Ordenar Descendente' href='index.php?pid=<?php echo base64_encode("ui/observador/selectAllObservadorByMatriculaEstudiante.php") ?>&idMatriculaEstudiante=<?php echo $_GET['idMatriculaEstudiante'] ?>&order=fecha&dir=desc'>
							<span class='fas fa-sort-amount-down'></span></a>
						<?php } ?>
						</th>
						<th>Profesor</th>
					...
					<?php
					$observador = new Observador("", "", "", "", "", $_GET['idMatriculaEstudiante']);
					if($order!="" && $dir!="") {
						$observadors = $observador -> selectAllByMatriculaEstudianteOrder($order, $dir);
					} else {
						$observadors = $observador -> selectAllByMatriculaEstudiante();
					}
					$counter = 1;
