...
if(isset($_POST['insert'])){
	$newProfesor = new Profesor("", $documento, $nombre, $apellido, $telefono, $estado, $correo, $clave, "null", $fecha_nacimiento, $tipoDocumento, $genero);
	$newProfesor -> insert();
	...
	if($_SESSION['entity'] == 'Administrador'){
	    $logAdministrador = new LogAdministrador("","Crear Profesor", "Documento: " . $documento . "; Nombre: " . $nombre . "; Apellido: " . $apellido . "; Telefono: " . $telefono . "; Estado: " . $estado . "; Correo: " . $correo . "; Clave: " . $clave . "; Foto: " . "null" . "; Fecha_nacimiento: " . $fecha_nacimiento . "; Tipo Documento: " . $nameTipoDocumento . ";; Genero: " . $nameGenero , date("Y-m-d"), date("H:i:s"), $user_ip, PHP_OS, $browser, $_SESSION['id']);
		...
		<div class="col-md-8">
			<div class="card">
				...
				<div class="card-body">
					...
					<?php } ?>
					<form id="form" method="post" action="index.php?pid=<?php echo base64_encode("ui/profesor/insertProfesor.php") ?>" class="bootstrap-form needs-validation"   >
