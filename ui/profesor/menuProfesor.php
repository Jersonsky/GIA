        <div class="l-navbar" id="navbar">
            <nav class="nav">
                <div>
                    ...
                    <div class="nav__list">
                        <a href="index.php?pid=<?php echo base64_encode("ui/profesor/sesionProfesor.php") ?>" class="nav__link active" style="color: var(--white-color);text-decoration: none;">
                            <i name="home-outline" class="fas fa-home nav__icon"></i>
                            
                            <span class="nav__name">Inicio</span>
                        </a>
                        
                        <a href="index.php?pid=<?php echo base64_encode("ui/profesor/cursosProfesor.php") ?>" class="nav__link" style="color: var(--white-color);text-decoration: none;" >
                             <i class="fas fa-book-open nav__icon"></i>
                            <span class="nav__name">Agregar Notas</span>
                        </a>
                        ...
                        <a href="index.php?pid=<?php echo base64_encode("ui/observador/hacerObservacionProfesor.php") ?>" class="nav__link" style="color: var(--white-color);text-decoration: none;" >
                             <i class="fas fa-calendar-week nav__icon"></i>
                            <span class="nav__name">Hacer Observaciones</span>
                        </a>
