...
<div class="container-fluid">
	<div class="card">
		<div class="card-header">
			<h4 class="card-title">Consultar Acudiente Estudiante</h4>
		</div>
		<div class="card-body">
			...
			<table class="table table-striped table-hover">
				<thead>
					<tr><th></th>
						...
						<?php } else { ?>
							<a href='index.php?pid=<?php echo base64_encode("ui/acudienteEstudiante/selectAllAcudienteEstudiante.php") ?>&order=fecha&dir=asc'>
						...
						<?php } else { ?>
							<a href='index.php?pid=<?php echo base64_encode("ui/acudienteEstudiante/selectAllAcudienteEstudiante.php") ?>&order=fecha&dir=desc'>
					...
					if($order != "" && $dir != "") {
						$acudienteEstudiantes = $acudienteEstudiante -> selectAllOrder($order, $dir);
					} else {
						$acudienteEstudiantes = $acudienteEstudiante -> selectAll();
					}
					$counter = 1;
